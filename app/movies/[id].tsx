    ...
    return (
        <View className="flex-1 bg-primary">
            <ScrollView contentContainerStyle={{ paddingBottom: 80 }} showsVerticalScrollIndicator={false}>
                ...
                <View className="flex-row items-start justify-start mt-5 px-5">
                    <Text className="text-white font-bold text-xl">{movie.title}</Text>
                </View>
                <View className="flex-row items-center gap-x-1 mt-2 px-5">
                    <Text className="text-light-200 text-sm">{movie.release_date?.split('-')[0]}</Text>
                    <Text className="text-light-200 text-sm">{movie.runtime}m</Text>
                </View>
                <View className="flex-row items-center max-w-[135px] bg-dark-100 px-2 py-1 rounded-md gap-x-1 mt-2 mx-5">
